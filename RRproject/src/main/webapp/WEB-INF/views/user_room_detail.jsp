...
<head>
    ...
    <!-- 내부css -->
    <link rel="stylesheet" href="resources/css/include/user_room_detail.css" type="text/css">
    <!-- 외부css -->
...
<body>
    <!-- 제일 먼저 wrapper로 감싸서 푸터부분이 표시되게 해준다 -->
    ...
    <div class="wrapper">
        ...
        <div class="left-section">
			...
			<hr class="custom-hr">
		<!-- 제공되는 서비스 부분 -->
		<span class="table-label" style="margin-right: 400px;">제공되는 서비스</span>
		...
		<!-- 테이블 배치 체크박스 -->
   		<span class="table-label" style="margin-right: 420px;">테이블 배치</span>
		<div class="checkbox-group">
...
<div class="right-section">
    <div class="hotel-info-box">
        ...
        <p>주소</p>
        <p>호텔 연락처</p>
        <p>선택한 날짜: 2023-09-30</p>
    </div>
    <div class="total-amount">
        <p>총 예약 금액</p>
        <p>12,000,000KRW</p>
    </div>
    <button class="heart-button">하트 버튼</button>
    <button class="reservation-button">예약 서 작성 버튼</button>
</div>

<script type="text/javascript">
const rightSection = document.querySelector('.right-section');
const initialTop = rightSection.getBoundingClientRect().top + window.scrollY;
